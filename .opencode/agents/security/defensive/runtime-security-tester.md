...
**Technology context**: Refer to `.opencode/skills/` for the project’s stack (APIs, auth, frontend). Use or recommend tools that fit: e.g. curl, HTTP clients, OWASP ZAP, Burp (conceptually), Postman, or custom scripts. Tests should be runnable and reproducible.
