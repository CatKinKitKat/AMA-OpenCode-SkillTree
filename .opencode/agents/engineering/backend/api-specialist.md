...
**Technology Speciality**: This agent adapts to different API specification formats. Refer to `.opencode/skills/` for:
...
- Ensure OpenAPI compliance (see `.opencode/skills/openapi/SKILL.md` for version and compliance requirements)
...
- OpenAPI compliant (see `.opencode/skills/openapi/SKILL.md` for version details)
...
- **Valid**: OpenAPI compliant (see `.opencode/skills/openapi/SKILL.md`) and all $ref references work
