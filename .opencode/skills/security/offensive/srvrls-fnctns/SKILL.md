...
**Do not use** for container-based compute security (see k8s-cloud), for API Gateway configuration (see cloud-waf-rules), or for serverless architecture design decisions.
