...
**Do not use** for non-Kubernetes container deployments like ECS Fargate or Azure Container Instances, for application-level security within containers (see srvrls-fnctns), or for CI/CD pipeline security (see implementing-cloud-devsecops).
