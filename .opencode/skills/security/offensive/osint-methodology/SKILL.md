...
Once asserted, don't re-ask. If the engagement type is stated ("pentest of the-project.com under contract"), proceed.
...
1. *"External recon on the-project.com (in-scope BB). Where do I start?"* → §0, §1, §7, §7.1.
