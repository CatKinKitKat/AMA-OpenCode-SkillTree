...
```bash
# Local the coding agent install
cp SKILL.md ~/.opencode/skills/offensive-osint/SKILL.md
cp scripts/secret_scan.py ~/.opencode/skills/offensive-osint/scripts/secret_scan.py

# Or attach to a the agent platform project / the assistant API system prompt
```
