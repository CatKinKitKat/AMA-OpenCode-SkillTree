...
**Do not use** for AWS-only environments (see aws-sec-hub), for identity provider configuration (see managing-cloud-identity), or for network-level firewall rule management (see cloud-waf-rules).
...
=============================================
Tenant: the-corp.onmicrosoft.com
