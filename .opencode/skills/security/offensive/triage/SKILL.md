...
- Bash(ls: *)
- Bash(wc: *)
- Bash(python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py: *)
---
...
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py` (checkpoint I/O).
...
reading source. This applies to the orchestrator and every subagent. Include the constraint in every Task prompt. For high-confidence HIGH
...
All checkpoint I/O goes through `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py`
...
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py load ./.triage-state`

- `status == "absent"` OR `"complete"`, OR `--fresh` in `$ARGUMENTS` →
  **fresh start.** Bash:
  `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py reset ./.triage-state`,
...
2. Bash → `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.triage-state <N> <name> --from ./.triage-state/_chunk.tmp`

**End of run.** After writing `TRIAGE.json` and `TRIAGE.md`, Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py done ./.triage-state 6`: -
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.triage-state 0 interview --from ./.triage-state/_chunk.tmp`
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.triage-state 1 ingest --from ./.triage-state/_chunk.tmp`: -
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.triage-state 2 dedup --from ./.triage-state/_chunk.tmp`: -
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.triage-state 3 verify --from ./.triage-state/_chunk.tmp`
...
2. Bash:
   `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py shard ./.triage-state <id> --from ./.triage-state/_chunk.tmp`
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.triage-state 4 rank --from ./.triage-state/_chunk.tmp`: -
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.triage-state 5 route --from ./.triage-state/_chunk.tmp`: -
...
2. Bash:
   `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py append ./TRIAGE.md --from ./.triage-state/_chunk.tmp`
...
```
/triage .opencode/skills/triage/fixtures/canary-findings.json --auto --repo targets/canary
```
...
- **Checkpoints are per-phase JSON**, not conversation state. The pipeline's
  ...
  doesn't help when the orchestrator's context window itself fills. File-backed checkpoints let a brand-new session pick up from the last
...
- **Bash is allowed narrowly** for `git log` (owner hints), `jq`/`find`
  (ingest), and `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py` (state I/O).
