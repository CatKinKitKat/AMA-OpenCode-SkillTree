...
**Do not use** for non-BES industrial systems (see iec-62443-sec-zones), for general IT compliance frameworks (see audi-clou-cis-bnch), or for physical security of substations without cyber components.
