...
**Do not use** for basic OT intrusion detection (see attacks-scada-systems), for malware analysis of Stuxnet samples (see malware reverse engineering skills), or for PLC programming and logic development.
