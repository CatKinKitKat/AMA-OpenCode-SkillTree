...
**Do not use** for non-DNP3 protocol monitoring (see modb-comm-injc-atta for Modbus), for DNP3 Secure Authentication configuration (separate implementation), or for protocol-agnostic network anomaly detection.
