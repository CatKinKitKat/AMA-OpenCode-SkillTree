...
**Do not use** for non-BES systems below NERC registration thresholds, for general OT assessment without power grid specifics (see ot-net-sec-assssm), or for physical security assessment of generation facilities without cyber scope.
