...
permitted only for `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py` (state I/O)
...
through `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py` (atomic, JSON-validated).
...
**Start of run.** Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py load ./.patch-state`

- `status == "absent"` OR `"complete"`, OR `--fresh` in `$ARGUMENTS` →
  fresh start. Bash:
  `python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py reset ./.patch-state`,
  proceed to Phase 0.
...
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.patch-state <N> <name> --from ./.patch-state/_chunk.tmp`

**End of run.** After writing `PATCHES.md` and `PATCHES.json`, Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py done ./.patch-state 4`: -
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.patch-state 0 mode --from ./.patch-state/_chunk.tmp`: -
...
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.patch-state 1 ingest --from ./.patch-state/_chunk.tmp`: -
...
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py shard ./.patch-state <id> --from ./.patch-state/_chunk.tmp`.
After all findings, write the consolidated phase payload to `_chunk.tmp` then:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.patch-state 2 generate --from ./.patch-state/_chunk.tmp`
...
Each subagent has read-only access to `--repo`. It cannot modify the target. It emits the diff as text in its response. The orchestrator writes that text
...
`{"phase": 3, "findings": [...]}`
Then Bash:
`python3 ~/.agent/skills/community/defending-code-reference-harness/_lib/checkpoint.py save ./.patch-state 3 review --from ./.patch-state/_chunk.tmp`: -
