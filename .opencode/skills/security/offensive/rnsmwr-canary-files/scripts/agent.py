...
CANARY_FILE_TEMPLATES = {
    ...
    "AWS_Access_Keys.csv": (
        ...
        b"svc-prod-deploy,AKIA_EXAMPLE_REDACTED,wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY\n"
        b"svc-backup,AKIA_EXAMPLE_REDACTED,je7MtGbClwBF/2Zp9Utk/h3yCo8nvbEXAMPLEKEY\n"
    ),
}
