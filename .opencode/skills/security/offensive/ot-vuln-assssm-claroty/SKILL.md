...
**Do not use** for active vulnerability scanning of PLCs and safety systems (see ot-net-sec-assssm for passive approaches), for IT-only vulnerability management (see standard vulnerability scanners), or for penetration testing (see performing-ics-penetration-testing).
