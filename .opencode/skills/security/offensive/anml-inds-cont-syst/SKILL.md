...
**Do not use** for signature-based detection of known exploits (see attacks-scada-systems), for IT network anomaly detection without OT protocols, or as a replacement for process safety systems (SIS).
