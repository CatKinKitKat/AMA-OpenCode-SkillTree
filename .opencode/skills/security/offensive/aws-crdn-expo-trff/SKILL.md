...
aws iam get-access-key-last-used --access-key-id AKIA_EXAMPLE_REDACTED
...
aws iam update-access-key \
  ...
  --access-key-id AKIA_EXAMPLE_REDACTED \
  --status Inactive
...
aws cloudtrail lookup-events \
  --lookup-attributes AttributeKey=AccessKeyId,AttributeValue=AKIA_EXAMPLE_REDACTED \
...
======================================
Scan Target: github.com/the-corp (42 repositories)
...
[CRED-001] AWS Access Key - VERIFIED ACTIVE
  Key ID: AKIA...WXYZ
  Repository: the-corp/backend-api
  File: deploy/config.env
  Commit: a1b2c3d (2025-08-15)
  Author: developer@the-project.com
...
[CRED-002] AWS Secret Key - VERIFIED ACTIVE
  Repository: the-corp/data-pipeline
  File: scripts/etl_config.py
  Commit: d4e5f6g (2025-11-22)
  Author: data-engineer@the-project.com
