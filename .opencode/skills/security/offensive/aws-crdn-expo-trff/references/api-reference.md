...
aws iam update-access-key --access-key-id AKIA_EXAMPLE_REDACTED \
  --user-name jsmith --status Inactive

# Delete key
aws iam delete-access-key --access-key-id AKIA_EXAMPLE_REDACTED \
  --user-name jsmith
...
WHERE useridentity.accesskeyid = 'AKIA_EXAMPLE_REDACTED'
