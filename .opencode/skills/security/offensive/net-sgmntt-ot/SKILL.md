...
**Do not use** for IT-only microsegmentation without OT components (see zero-trust-cloud), or for initial zone design without prior traffic analysis (see performing-ot-network-security-assessment first).
