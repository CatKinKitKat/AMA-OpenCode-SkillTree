...
**Do not use** for IT-only database security without OT data (see general database hardening), for real-time SCADA data transmission security (see attacks-scada-systems), or for historian selection and sizing decisions.
