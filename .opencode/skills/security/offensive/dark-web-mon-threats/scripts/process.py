...
Usage:
    python process.py --org "the-project Corp" --domains the-project.com,the-project.io --check-credentials
    python process.py --org "the-project Corp" --check-ransomware
    python process.py --org "the-project Corp" --full-scan --output report.json
"""
