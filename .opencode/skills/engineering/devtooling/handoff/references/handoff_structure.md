...
- Branch: the agent/handoff-skill-review-LnSxe
...
- Anthropic, *the coding agent SessionStart hooks documentation*: surfacing prior context as data, not instructions.
