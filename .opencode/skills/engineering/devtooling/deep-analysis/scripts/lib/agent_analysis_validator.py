...
Catches malformed structures from non-The agent LLMs (Codex / 国产模型 etc) so
...
The validator is INTENTIONALLY lenient on The agent's variations. It only flags
...
if __name__ == "__main__":
    ...
    print(format_issues(iss))
    print()
    print("=== Test 3: clean The agent-style payload ===")
    iss = validate({
        "agent_reviewed": True,
