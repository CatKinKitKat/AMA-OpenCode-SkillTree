...
mcporter auto-discovers servers configured by other MCP clients (The agent Desktop, Cursor, etc.) on the machine. To find new servers to use, browse registries like [mcpfinder.dev](https://mcpfinder.dev) or [mcp.so](https://mcp.so), then connect ad-hoc:
...
# Machine-readable output (recommended for the agent)
