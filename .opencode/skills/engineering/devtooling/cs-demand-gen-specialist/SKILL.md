...
**Steps:**
1. **Context**: read `.opencode/product-marketing-context.md`. Confirm objective, monthly budget, target CAC, ICP.
...
**Steps:**
1. **Context**: read `.opencode/product-marketing-context.md`. Confirm sequence type, trigger, goal, and exit conditions per the email-sequence intake.
