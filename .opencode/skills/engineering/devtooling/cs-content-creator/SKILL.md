...
```bash
cat .opencode/product-marketing-context.md 2>/dev/null
```
...
3. **Brand Voice Analyzer**: tone markers, sentence-rhythm stats, vocabulary fingerprint
   ...
   - **Use:** compare output against the brand profile in `.opencode/product-marketing-context.md`. Rewrite sections that drift
...
**Steps:**
1. **Context**: read `.opencode/product-marketing-context.md`. Collect topic, primary keyword, audience, goal, length.
...
**Steps:**
1. **Load the brand profile**: brand-voice section of `.opencode/product-marketing-context.md`.
...
- **Marketing domain guide:** [../../marketing-skill/AGENTS.md](../../marketing-skill/AGENTS.md)
