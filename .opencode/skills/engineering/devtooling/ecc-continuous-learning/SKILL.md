...
Automatically evaluates the coding agent sessions on end to extract reusable patterns that can be saved as learned skills.

## When to Activate

- Setting up automatic pattern extraction from the coding agent sessions
- Configuring the Stop hook for session evaluation
- Reviewing or curating learned skills in `~/.opencode/skills/learned/`
