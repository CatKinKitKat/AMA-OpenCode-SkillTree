...
- Anthropic, [the coding agent best practices](https://www.anthropic.com/engineering/coding-agent-best-practices): verification loops and target-based iteration for agentic runs
...
- Anthropic, [Prompt engineering overview](https://docs.the assistant.com/en/docs/build-with-the assistant/prompt-engineering/overview): clarity of desired outcome over prescriptive process
