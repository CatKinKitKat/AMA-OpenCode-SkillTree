...
- **the coding agent CLI:** Native: writes markdown files directly to filesystem.
- **the agent platform web:** Works with project files / artifacts. Document the alternate path: generate files as artifacts, instruct user to save to their workspace, or use connected file system if available.
