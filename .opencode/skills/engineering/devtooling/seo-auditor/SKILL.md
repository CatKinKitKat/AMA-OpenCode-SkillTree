...
|: : : : : -|: : : : : : : : -|: : : : : : : : : -|
| Homepage (docs/index.md) | "the coding agent Skills", "agent plugins" | "Codex skills", "Gemini CLI", "OpenClaw" |
| Skill pages | Skill name + "the coding agent" | "agent skill", "Codex plugin", domain terms |
| Agent pages | Agent name + "AI coding agent" | "the coding agent", "orchestrator" |
| Command pages | Command name + "slash command" | "the coding agent", "AI coding" |
| Getting started | "install the coding agent skills" | platform names |
| Domain index | Domain + "skills" + "plugins" | "the coding agent", platform names |
...
- `docs/index.md`: homepage, ranks for "the coding agent Skills"
