...
description: Multi-agent orchestration using dmux (tmux pane manager for AI agents). Patterns for parallel agent workflows across the coding agent, Codex, OpenCode, and other harnesses. Use when running multiple agent sessions in parallel or coordinating multi-agent development workflows.
origin: ECC
---
...
- Coordinating work across the coding agent, Codex, and other harnesses
...
- Supports: the coding agent, Codex, OpenCode, Cline, Gemini, Qwen
...
```
Pane 1 (the coding agent): "Review the security of the auth module"
Pane 2 (Codex): "Refactor the utility functions for performance"
Pane 3 (the coding agent): "Write E2E tests for the checkout flow"
```
...
# Pane 1: cd ../feature-auth && the agent
# Pane 2: cd ../feature-billing && the agent
...
| **the coding agent Task tool** | In-process subagent spawning | Programmatic parallelism within a session |
...
```json
{
  ...
  "seedPaths": [
    ...
    ".opencode/plan/workflow-e2e-test.json"
  ],
