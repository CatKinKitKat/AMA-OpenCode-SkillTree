...
1. **Energy and attention decay.** Decision quality degrades as a session wears on. Putting the
   ...
   practical agenda guidance consistently recommends sequencing the most important items first: also because meetings compress from the end when they start late or run over.
...
surface late. A recap slot is the last cheap moment to catch "wait, that's not what I agreed to": which only happens if people feel safe saying it, Amy Edmondson's core argument for psychological
...
5. Andrew S. Grove, *High Output Management*, Random House, 1983 (process vs mission meetings. The decision is the meeting. Chairman accountability).
