...
| Skills directory | `ls ~/.opencode/skills ~/.codex/skills` where applicable | Say no local skill catalog was available |
...
2. Is there an MCP for this? → Check `~/.opencode/settings.json` and search
3. Is there a skill for this? → Check `~/.opencode/skills/`
...
Agent(subagent_type="general-purpose", prompt="
  ...
  Search: npm/PyPI, MCP servers, the coding agent skills, GitHub
...
### AI/LLM Integration
- The agent SDK → Context7 for latest docs
