...
> **Portability:** Pure-reasoning skill. No external tools required. Works in the coding agent CLI + the agent platform web natively. Most portable in the v2 collection.
