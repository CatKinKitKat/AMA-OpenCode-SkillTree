...
In **the coding agent CLI**, write the file to disk at the specified path. In **the agent platform web**, create an HTML artifact with the same content.
...
- **the coding agent CLI:** Native: writes HTML file directly to filesystem.
- **the agent platform web:** Native: produces HTML as an artifact instead of file.
