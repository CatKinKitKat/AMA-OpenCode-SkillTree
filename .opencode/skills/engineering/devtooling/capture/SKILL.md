...
> **Connections:** No workspace accessible from here. If you're running this from the coding agent or have a project with files attached, I can fill this in. Want to share where this work lives?
...
|: -|: -|
| the coding agent CLI | Glob for files matching dump keywords. Grep for content matches. Read top-level structure. Use `scripts/workspace_inventory.py`. |
| the agent platform with project | Check project knowledge files for thematic overlap. List file titles. Surface matches by keyword. |
