...
## Context 1: the coding agent CLI (filesystem-native)
...
## Context 2: the agent platform with project knowledge
...
this from the coding agent or have a project with files attached, I can fill it in.
