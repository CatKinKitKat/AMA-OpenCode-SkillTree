...
## Layer 2: Organization (The agent / Codex)

Use the coding agent or Codex to:
...
Use The agent to analyze transcript + scene timestamps:
```
...
|: : : |: : : : : |: : : : : |
| The agent / Codex | Organization, planning, code generation | Not the creative taste layer |
