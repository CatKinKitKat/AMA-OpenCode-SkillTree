...
(`https://mcp.atlassian.com/v1/sse`, OAuth handled by the coding agent).
...
- **HEALTH lane**: "Is your project status self-reported RAG or derived from signals?
  ...
  self-report: that diff finds watermelon projects. Canon: Kanban Guide 2025. DORA 2025 (AI amplifies, doesn't fix, weak signals)."
...
- [references/agentic_delivery_governance.md](references/agentic_delivery_governance.md): Linear/Rovo delegation models, Anthropic agent patterns, audit discipline
