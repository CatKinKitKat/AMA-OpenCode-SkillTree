...
- `~/.opencode/company-context.md` (loaded automatically)

## Output

A single Markdown file under `~/.opencode/briefs/YYYY-MM-DD-<slug>.md` with this structure:
