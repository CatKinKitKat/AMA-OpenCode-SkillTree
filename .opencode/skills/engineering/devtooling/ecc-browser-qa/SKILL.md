...
Uses the browser automation MCP (the agent-in-chrome, Playwright, or Puppeteer) to interact with live pages like a real user.
...
- `mChild__the agent-in-chrome__*` tools (preferred: uses your actual Chrome)
