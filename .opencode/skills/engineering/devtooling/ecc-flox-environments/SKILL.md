...
This makes Flox a natural fit for any workflow where the coding agent or other AI agents need to bootstrap project tooling on the fly.
...
The following skills are available as part of the [Flox the coding agent plugin](https://github.com/flox/flox-agentic) for deeper integration:
