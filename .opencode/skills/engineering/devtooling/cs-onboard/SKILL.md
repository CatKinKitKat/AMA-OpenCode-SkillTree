...
After the interview, generate `~/.opencode/company-context.md` using `templates/company-context-template.md`.
...
`~/.opencode/company-context.md`: single source of truth for all C-suite skills. Do not move it. Do not create duplicates.
