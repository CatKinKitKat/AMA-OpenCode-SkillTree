...
description: Use when auditing The agent skills and commands for quality. Supports Quick Scan (changed skills only) and Full Stocktake modes with sequential subagent batch evaluation.
origin: ECC
---
...
Slash command (`/skill-stocktake`) that audits all The agent skills and commands using a quality checklist + AI holistic judgment. Supports two modes: Quick Scan for recently changed skills, and Full Stocktake for a complete review.
...
| Path | Description |
|: : : |: : : : : : -|
| `~/.opencode/skills/` | Global skills (all projects) |
...
If the project has no `.opencode/skills/` directory, only global skills and commands are evaluated.
...
**Results cache:** `~/.opencode/skills/skill-stocktake/results.json`

## Quick Scan Flow

Re-evaluate only skills that have changed since the last run (5–10 min).

1. Read `~/.opencode/skills/skill-stocktake/results.json`
2. Run: `bash ~/.opencode/skills/skill-stocktake/scripts/quick-diff.sh \
         ~/.opencode/skills/skill-stocktake/results.json`
...
7. Run: `bash ~/.opencode/skills/skill-stocktake/scripts/save-results.sh \
         ~/.opencode/skills/skill-stocktake/results.json <<< "$EVAL_RESULTS"`

## Full Stocktake Flow

### Phase 1: Inventory

Run: `bash ~/.opencode/skills/skill-stocktake/scripts/scan.sh`
