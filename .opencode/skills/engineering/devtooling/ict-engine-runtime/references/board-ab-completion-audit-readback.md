...
2. Read the repo entry contract first (`AGENT.md`. `AGENTS.md` may point to it). Honor the rule: current docs are terminal decisions only. Start claims live outside repo.
