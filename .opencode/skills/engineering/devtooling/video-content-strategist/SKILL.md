...
> Originally contributed by [chad848](https://github.com/chad848): enhanced and integrated by the community contributors.
...
**Check for context first:** If `.opencode/product-marketing-context.md` exists, read it before asking questions. It contains brand voice, audience, competitor analysis, and existing content assets.
