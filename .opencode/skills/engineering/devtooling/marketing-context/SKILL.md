...
The document is stored at `.opencode/product-marketing-context.md`: the canonical path every marketing skill in this library reads. Always write to this path.

> **Backward compatibility:** if you previously created `.agents/marketing-context.md` or a root-level `marketing-context.md`, move it to `.opencode/product-marketing-context.md` so sibling skills can find it.
...
```bash
python3 scripts/context_validator.py .opencode/product-marketing-context.md --json
```
...
|: : : : : : : : : : -|: : : : : : |
| "Set up marketing context" | Guided interview → complete `.opencode/product-marketing-context.md` |
