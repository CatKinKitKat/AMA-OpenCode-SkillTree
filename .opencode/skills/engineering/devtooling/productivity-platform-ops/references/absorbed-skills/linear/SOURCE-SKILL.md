...
2. Set `LINEAR_API_KEY` in your environment (via `agent setup` or your env config)
...
The trailing hex segment is the `slugId`. Example: `https://linear.app/nousresearch/document/rfc-agent-permission-gateway-discord-38359beef67c` → `slugId` is `38359beef67c`.
