...
```bash
# Install with uv (recommended — already available in the agent)
...
# Fix content
nano-pdf edit contract.pdf 2 "Change the client name from 'the-project Corp' to 'the-project Industries'"
```
