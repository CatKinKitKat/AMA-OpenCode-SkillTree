...
1. Create directory: `mkdir -p .opencode/skills/trellis-local`
2. Copy the template below to `.opencode/skills/trellis-local/SKILL.md`
...
- **File**: `.opencode/commands/trellis/command-name.md`
- **Platform**: [ALL] or [CC] (the coding agent only)
...
> **Note**: Agent auto-loading is [CC] (the coding agent only). On Cursor, agents are read manually.

### Added Agents

<!-- Template for new agent:
#### agent-name [CC]
- **File**: `.opencode/agents/agent-name.md`
...
> **the coding agent Only**: Hooks require the coding agent's hook system. Not available on Cursor.
...
SKILL_DIR=".opencode/skills/trellis-local"
