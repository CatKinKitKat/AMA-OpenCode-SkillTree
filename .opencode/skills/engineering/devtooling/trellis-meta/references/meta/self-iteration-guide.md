...
│   │   └── Update .opencode/skills/trellis-local/SKILL.md
│   │
│   ├── Bug fix to core Trellis
│   │   └── Update ~/.opencode/skills/trellis-meta/
...
ls .opencode/skills/trellis-local/SKILL.md

# If not, create it from template
mkdir -p .opencode/skills/trellis-local
...
Open `.opencode/skills/trellis-local/SKILL.md` and:
...
```markdown
#### /trellis:my-command
- **File**: `.opencode/commands/trellis/my-command.md`
...
~/projects/
├── project-a/
│   └── .opencode/skills/trellis-local/   # Project A customizations
├── project-b/
│   └── .opencode/skills/trellis-local/   # Project B customizations
└── project-c/
    └── .opencode/skills/trellis-local/   # Project C customizations
...
diff -r ~/.opencode/skills/trellis-meta/references/ \
...
cp -r ~/.opencode/skills/trellis-meta ~/.opencode/skills/trellis-meta.backup

# Update meta-skill
cp -r ./new-trellis-meta/* ~/.opencode/skills/trellis-meta/
```
...
Example AI response:
> "I've added the `/trellis:deploy` command and documented it in `.opencode/skills/trellis-local/SKILL.md` under the Commands section."
