...
| Platform | Agent path |
| --- | --- |
| the coding agent | `.opencode/agents/trellis-*.md` |
...
4. **Keep semantics synchronized in multi-platform projects**. If the user configured The agent, Codex, and Cursor together, decide whether changes to one platform's agent also need to be applied to others.
