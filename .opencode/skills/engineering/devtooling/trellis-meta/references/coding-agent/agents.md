...
**File**: `.opencode/agents/dispatch.md`
...
**File**: `.opencode/agents/research.md`
...
**File**: `.opencode/agents/implement.md`
...
1. the coding agent looks for `.opencode/agents/{subagent_type}.md`
