...
These scripts work on all platforms - they only read/write files and don't require the coding agent's hook system.
...
**Dev types:** `engineering/frontend`, `engineering/backend`, `fullstack`
