...
| `dev_type` | string\|null | `engineering/frontend`, `engineering/backend`, `fullstack`, `test`, `docs` |
...
Dev types: `engineering/frontend`, `engineering/backend`, `fullstack`, `test`, `docs`
