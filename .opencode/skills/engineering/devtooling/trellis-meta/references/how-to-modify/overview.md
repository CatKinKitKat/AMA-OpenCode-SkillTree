...
**Platform**: `All` = All platforms | `CC` = the coding agent only
...
```
.opencode/commands/trellis/my-command.md    # Create: Command prompt
...
```
.opencode/agents/my-agent.md                          # Create: Agent definition
.opencode/hooks/inject-subagent-context.py            # Modify: Add agent handling
...
**Optional**:
```
.opencode/agents/dispatch.md                          # Modify: If adding to pipeline
...
```
.opencode/hooks/{hook-name}.py              # Modify: Hook logic
.opencode/settings.json                     # Modify: If changing matcher/timeout
.trellis-local/SKILL.md                   # Update: Document the change
```
...
.opencode/agents/dispatch.md                # Modify: Handle new phase
.opencode/agents/{new-phase}.md             # Create: If new agent needed
.opencode/hooks/inject-subagent-context.py  # Modify: If new agent
.trellis-local/SKILL.md                   # Update: Document the change
```
...
```
.opencode/hooks/session-start.py            # Modify: Injection logic
.trellis-local/SKILL.md                   # Update: Document the change
```
