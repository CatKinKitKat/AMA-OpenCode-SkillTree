...
1. **Confirm platform and directories**: inspect which directories exist, such as `.opencode/`, `.codex/`, `.cursor/`.
...
| Platform integration | `.opencode/`, `.codex/`, `.cursor/`, `.opencode/`, and similar directories |
