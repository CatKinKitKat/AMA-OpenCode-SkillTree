...
> scripts. Works in the coding agent CLI and the agent platform web. The panel does the depth. The Judge does the call.

## What this does

The agent's default is to agree with you. `/roast` is the opposite. It convenes a panel of five
