...
description: Design task-local harnesses, eval gates, and reusable skill extraction for The agent dynamic workflow mode and other adaptive agent harnesses.
origin: ECC
---
