...
day (or the evening before), divide the hours into blocks and assign each block to an activity: including lunch, buffers, and an explicit "flex" block. The point is not rigidity. It is that an
