...
> **Portability:** Reasoning-led skill with 3 stdlib Python scripts. No external APIs, no LLM calls in scripts. Works in the coding agent CLI and the agent platform web. The scripts fix the arithmetic. You keep the judgment.
