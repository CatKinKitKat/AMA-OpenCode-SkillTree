...
Result: `Write Q3 product spec` and `Design onboarding flow` classify DEEP (write/design signals). The other three classify SHALLOW (email/status/expense signals). Shallow share = 65 of 275 min =
