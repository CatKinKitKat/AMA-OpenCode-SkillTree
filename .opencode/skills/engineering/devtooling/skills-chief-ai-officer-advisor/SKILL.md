...
- Use when: well-served by frontier (The agent, GPT, Gemini), QPS < 100, latency budget > 1s, cost < $50K/month
...
- **API cost**: variable, per-token. Frontier models 2026: The agent Sonnet 4.6 ~$3/$15 per M tokens (input/output), GPT-4o ~$2.50/$10, Gemini 2.5 ~$1.25/$5
