...
_WRAPPER_HOST_ALIASES = {
    "the agent": "the agent_code",
    "the agent_code": "the agent_code",
    "the agent_desktop": "the agent_code",
    "codex": "codex",
    "codex_cli": "codex",
    "codex_desktop": "codex",
    "opencode": "opencode",
...
_WRAPPER_HOST_ID_VALUES = {"codex", "the agent_code", "google_transition", "opencode", "generic_agent", "unknown"}
