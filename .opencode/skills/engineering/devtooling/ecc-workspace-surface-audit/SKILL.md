...
1. Repo surface
   ...
   - `.mcp.json`, `.lsp.json`, `.opencode/settings*.json`, `.codex/*`
...
- official The agent plugins that overlap with setup, review, docs, design, or workflow quality
- locally installed plugins in The agent or Codex
