...
maintains a state of tension that keeps it active in memory. Completion releases the tension. Interruption preserves it.

For a personal system, the implication is direct: every commitment you've made and not resolved: the un-replied email, the half-done project, the promise made in a hallway: is an *open loop*
...
2. E.J. Masicampo & Roy F. Baumeister, "Consider It Done! Plan Making Can Eliminate the Cognitive
   Effects of Unfulfilled Goals," *Journal of Personality and Social Psychology* 101(4), 2011: plan-making eliminates goal intrusions without completion.
