...
1. **First run ever?** Use `skills/marketing-context/` to create `.opencode/product-marketing-context.md`. Every other skill reads it for brand voice, personas, and competitive landscape.
...
- If `.opencode/product-marketing-context.md` exists, read it before any marketing task.
