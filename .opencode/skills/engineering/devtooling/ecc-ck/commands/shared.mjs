...
export const CK_HOME          = resolve(homedir(), '.the agent', 'ck');
...
export const SKILL_FILE       = resolve(homedir(), '.the agent', 'skills', 'ck', 'SKILL.md');
...
export function nativeMemoryDir(absolutePath) {
  ...
  return resolve(homedir(), '.the agent', 'projects', encoded, 'memory');
}
