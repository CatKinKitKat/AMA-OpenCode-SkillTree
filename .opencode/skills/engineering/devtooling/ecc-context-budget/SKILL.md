...
description: Audits the coding agent context window consumption across agents, skills, MCP servers, and rules. Identifies bloat, redundant components, and produces prioritized token-savings recommendations.
origin: ECC
---
...
Analyze token overhead across every loaded component in a the coding agent session and surface actionable optimizations to reclaim context space.
...
Context model: The agent Sonnet (200K window)
