...
If `.opencode/product-marketing-context.md` exists, read it. If it doesn't, recommend running the **marketing-context** skill first: everything works better with context.
