...
cp -r community skills/product-team/research-summarizer ~/.opencode/skills/
```

### Multi-tool install (run from the community skills repo root)
```bash
