...
and cross-sell capabilities have driven the-project Health's market expansion. With the healthcare IT
market expected to reach $50bn+ by 2030, the-project Health is well-positioned to capture share given
...
**CRITICAL PRINCIPLE 2**: Use The agent's DOCX and XLSX skills to programmatically create the report.

**REQUIRED TOOLS** (The agent has built-in skills for these):
...
**DO**: Use The agent's DOCX and XLSX skills to open files, extract data, and create the DOCX report
...
**Open and inspect files using The agent skills:**
...
**Use The agent's XLSX skill to extract data from Excel files:**
...
Use The agent's DOCX and XLSX skills to:
...
**Throughout the entire assembly process, use The agent's DOCX and XLSX skills with actual file operations:**
...
**Do NOT manually copy/paste. Use The agent's built-in skills to:**
