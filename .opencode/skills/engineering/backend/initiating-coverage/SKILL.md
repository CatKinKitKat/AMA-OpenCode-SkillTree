...
3. Execute report assembly workflow using The agent's built-in skills:
...
**Key Principles**:
- Use The agent's DOCX and XLSX skills (NOT Python libraries)
...
The agent: "Starting Task 5: Report Assembly for Tesla
