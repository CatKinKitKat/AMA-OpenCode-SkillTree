...
Intake-first authoring of deterministic multi-agent **workflow `.js` files** for the coding agent's Workflow tool (`CLAUDE_CODE_WORKFLOWS=1`, `/workflows`). See the plugin root [README](../../README.md) for the full overview and attribution.
