...
1. Ray Amjad: `the agent-code-workflow-creator`, `references/patterns.md` (fan-out, pipeline, judge-panel, loop shapes).
2. Anthropic: the coding agent Workflow tool documentation (`pipeline`/`parallel` semantics).
