...
4. Run AQ variants in isolated `/tmp/ict-engine-runs/...` state dirs with `--repo-url ~/Auto-Quant` when available.
...
- Candidate triage result: `/tmp/ict-engine-runs/20260518T150000+0800-agent-candidate-tune-inventory-v1/checks/candidate_tune_results.json`
- SMH Keltner v2 parity run: `/tmp/ict-engine-runs/20260518T151500+0800-agent-smh-keltner-ibkr-parity-v3/summaries/terminal_decision_summary.md`
