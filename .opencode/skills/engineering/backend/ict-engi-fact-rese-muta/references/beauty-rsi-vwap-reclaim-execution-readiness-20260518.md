...
## Gate 1 result
- Source run: `support/docs/experiments/actionable-regime-confidence/runs/20260518T184353+0800-agent-yf-beauty-personal-care-rsi-vwap-reclaim-1m-dense-v3/`
...
- Readback run: `support/docs/experiments/actionable-regime-confidence/runs/20260518T190002+0800-agent-beauty-dense-v3-execution-readiness-readback-v1`
