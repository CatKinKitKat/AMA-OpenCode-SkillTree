...
```text
~/projects-ict-engine/ict-engine/support/docs/experiments/actionable-regime-confidence/runs/20260520T182116+0800-codex-m2k-execution-admission-reverse-gate-diagnostic-v1
```

Simulated trade admission refresh:

```text
~/projects-ict-engine/ict-engine/support/docs/experiments/actionable-regime-confidence/runs/20260520T093302+0800-codex-ibkr-m2k1m-rvol-pda-consistency-floor-7d-gate1-v1/simulated-trade-admission-m2k-1m-rvol-pda-consistency-floor-20260520T182204+0800
```
