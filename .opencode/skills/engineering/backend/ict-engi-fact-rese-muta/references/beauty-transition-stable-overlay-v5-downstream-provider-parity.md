...
Source Gate 1 run:
`support/docs/experiments/actionable-regime-confidence/runs/20260518T193741+0800-agent-yf-beauty-rsi-vwap-transition-stable-overlay-1m-v5`

Downstream run:
`.../downstream-20260518T195834+0800-agent`

Provider parity probes:
- IBKR: `20260518T194902+0800-agent-ibkr-beauty-transition-stable-v5-provider-parity-probe`
- TradingViewMCP: `20260518T195006+0800-agent-tvr-beauty-transition-stable-v5-provider-parity-probe`
