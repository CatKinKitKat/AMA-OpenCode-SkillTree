...
training from `~/Downloads/Tomac/* future 2021-2025` data.
...
- Source:
  `~/Downloads/Tomac/xau future 2021-2025/glbx-mdp3-20210106-20260105.ohlcv-1m.csv`
- Selection:
...
as year-stability/2024-regime isolation or a different VWAP mean-reclaim child. Do not rerun the same NQ exact AQ packet unchanged.
