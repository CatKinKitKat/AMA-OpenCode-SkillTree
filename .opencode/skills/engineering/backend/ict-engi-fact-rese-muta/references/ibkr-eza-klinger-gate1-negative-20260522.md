...
- Root:
  `~/projects-ict-engine/ict-engine/support/docs/experiments/actionable-regime-confidence/runs/20260522T181328+0800-codex-ibkr-eza-klinger-volume-flow-1m-gate1-v1`
- Claim:
...
- Root:
  `~/projects-ict-engine/ict-engine/support/docs/experiments/actionable-regime-confidence/runs/20260523T012658+0800-codex-ibkr-mcl202607-klinger-volume-flow-1m-mtf-gate1-v1`
- Claim:
