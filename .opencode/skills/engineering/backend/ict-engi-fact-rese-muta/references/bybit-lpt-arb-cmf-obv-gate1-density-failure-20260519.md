...
`~/projects-ict-engine/ict-engine/support/docs/experiments/actionable-regime-confidence/runs/20260519T135842+0800-agent-bybit-lpt-arb-cmf-obv-breakout-1m-mtf-v1`
...
- external claim: `/tmp/ict-engine-agent-claims/board-b-factor-refinement/agent-bybit-lpt-arb-cmf-obv-breakout-1m-mtf-v1.claim`
