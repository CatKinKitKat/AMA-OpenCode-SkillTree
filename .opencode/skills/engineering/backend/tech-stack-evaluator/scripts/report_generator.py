...
Generates reports adapted for The agent Desktop (rich markdown) or CLI (terminal-friendly),
...
class ReportGenerator:
    ...
    def _detect_context(self) -> str:
        ...
        """
        # Check for The agent Desktop environment variables or indicators
        # This is a simplified detection - actual implementation would check for
        # The agent Desktop-specific environment variables
