...
response = client.messages.create(
    model="the agent-3-opus-20240229",
    messages=[{"role": "user", "content": "Search for AI news"}],
    tools=schemas['tools']
)
```
...
This skill is part of the community skills repository. To contribute:
...
- Create an issue in the community skills repository