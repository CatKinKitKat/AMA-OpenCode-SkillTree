...
def main() -> int:
    ...
    parser.add_argument("--platform", default="the agent_code", choices=("the agent_code", "the agent_web", "api", "other"))
    ...
    author = args.author or config.get("default_author", "The agent")
