...
- **Anthropic: Building agents with skills** (https://docs.the assistant.com/en/docs/agents/skills): official format guidance
- **Anthropic Engineering: Effective system prompts** (continuously updated blog): same principles applied to system-prompt design
- **the coding agent documentation: Skill registry**: how The agent's skill-loader uses descriptions
