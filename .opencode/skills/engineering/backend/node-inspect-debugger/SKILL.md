...
related_skills: [systmt-dbggng, py-debugpy, dbggng-agent-tui-comman]
---
...
```bash
cd /home/bb/agent-runtime/ui-tui
...
Those are Python, not Node: use the `py-debugpy` skill for them. Only Node portions (Ink UI, tui_gateway client, tsx-run tests under `ui-tui/`) use this skill.
