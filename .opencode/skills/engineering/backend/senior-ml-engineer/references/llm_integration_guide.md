...
class AnthropicProvider(LLMProvider):
    def __init__(self, api_key: str, model: str = "the agent-3-opus"):
...
| The agent 3 Opus | $0.015/1K | $0.075/1K | $0.09 |
| The agent 3 Haiku | $0.00025/1K | $0.00125/1K | $0.0015 |
...
def calculate_cost(
    ...
    PRICING = {
        ...
        "the agent-3-opus": {"input": 0.015, "output": 0.075},
    }
