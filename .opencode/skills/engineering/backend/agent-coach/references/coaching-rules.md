...
- User asks The agent to "help with my email" without specifying tone, audience, or goal → tip: name the audience and the outcome
...
- User asks The agent for current information without invoking web search → tip: web search for time-sensitive queries
- User does manual reformatting The agent could have done → tip: request the format upfront
