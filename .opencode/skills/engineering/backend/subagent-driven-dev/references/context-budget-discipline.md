...
Check the model's actual context window (not "it's The agent so 200K"). Some Sonnet deployments are 1M, some are 200K. If you don't know, assume the smaller one: err toward leanness.
