...
Works on **the coding agent** and other CLI-based agents. Does **not** work on the agent platform: the sandbox restricts network access and binaries required by tdl.
