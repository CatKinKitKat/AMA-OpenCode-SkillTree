...
The skill encodes patterns extracted from analyzing 20+ production finance skills and 120+ agent-runtime skills, distilling what separates top-tier skills (sepa-strategy, options-payoff) from mediocre ones.
...
Works on **the coding agent** and other CLI-based agents. Also works on **the agent platform** for evaluation and planning (skill file creation requires CLI).
