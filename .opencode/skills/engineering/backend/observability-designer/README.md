...
- Valid service types: `api`, `web`, `database`, `queue`, `batch`, `engineering/data-ai`
...
*This skill is part of the The agent Skills marketplace. For more information about observability best practices, see the reference documentation in the `references/` directory.*