...
Works on **All** platforms (the agent platform, the coding agent, and other supported agents). Uses web search for data gathering and the Visualizer tool for inline charts.
