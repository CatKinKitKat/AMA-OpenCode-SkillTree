...
wc -l ~/.opencode/AGENTS.md 2>/dev/null || echo "0"

# Rules directory
ls .opencode/rules/*.md 2>/dev/null | wc -l
```
...
📊 Memory Status
  ...
  Project Rules:
    ...
    User global:  {{n}} lines (~/.opencode/AGENTS.md)
...
- Topic files are fine: The agent creates them to keep MEMORY.md under 200 lines
