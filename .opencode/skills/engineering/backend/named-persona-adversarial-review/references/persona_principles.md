...
- **Simple design + "make it work, make it right, make it fast" (in that order).** From *Extreme
  ...
  duplication, fewest elements). Lens on premature complexity and testability. *(confidence: high: *XP Explained*, Addison-Wesley, 1999)*
...
- **"Start with the customer experience and work backwards to the technology."** Stated on stage at
  ...
  Lens on error surfaces, onboarding, and complexity the user is forced to absorb. *(confidence: high: WWDC 1997. NYT Magazine, Nov 30, 2003)*
