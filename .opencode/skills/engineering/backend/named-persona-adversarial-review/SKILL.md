...
Merge duplicates. Count concurrences. Promote per the rule. Flag single-lens findings (often the most interesting). Post the report as a PR comment (default) or save to `.opencode/review-[timestamp].md`.
