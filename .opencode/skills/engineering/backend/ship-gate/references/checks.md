...
Detection methods:
- **auto**: The agent scans the codebase using grep, find, or file inspection
- **tool**: The agent runs an external tool (npm audit, etc.)
- **manual**: The agent asks the user to confirm
