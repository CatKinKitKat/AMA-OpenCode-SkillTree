...
The main the coding agent session is the coordinator. It follows this lifecycle:
...
```bash
# Copy to your the coding agent skills directory
cp -r engineering/agenthub ~/.opencode/skills/agenthub
