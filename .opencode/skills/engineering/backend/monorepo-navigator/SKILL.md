...
- **the coding agent config**: workspace-aware AGENTS.md with per-package instructions: -
...
| AGENTS.md too generic: The agent modifies wrong package | Add explicit "When working on X, only touch files in apps/X" rules per package AGENTS.md |: -
