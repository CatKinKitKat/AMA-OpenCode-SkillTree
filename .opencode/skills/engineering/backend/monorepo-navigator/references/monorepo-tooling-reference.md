...
## the coding agent Configuration (Workspace-Aware AGENTS.md)

Place a root AGENTS.md + per-package AGENTS.md files:

```markdown
# /AGENTS.md — Root (applies to all packages)
...
```markdown
# /packages/ui/AGENTS.md — Package-specific
