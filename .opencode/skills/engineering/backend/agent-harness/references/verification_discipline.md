...
1. **Jason Wei, "Asymmetry of verification and verifier's law", Jul 2025**: https://www.jasonwei.net/blog/asymmetry-of-verification-and-verifiers-law. "The ease of
...
4. **Boris Cherny (Anthropic), "the coding agent: Best practices for agentic coding", Apr 2025**: https://www.anthropic.com/engineering/coding-agent-best-practices. The strongest loop is
   test-driven: write the check first, confirm it fails, then iterate work against it: "The agent performs best when it has a clear target to iterate against." Design consequence:
...
5. **Noah Shinn et al., "Reflexion: Language Agents with Verbal Reinforcement Learning",
   ...
   Cannot Self-Correct Reasoning Yet", ICLR 2024**: https://arxiv.org/abs/2310.01798: intrinsic self-correction without external feedback often makes answers worse. Design
...
7. **Google SRE Workbook (Beyer et al., 2018), ch. 2 "Implementing SLOs"**: https://sre.google/workbook/implementing-slos/. Error budgets are the production-grade
