...
2. **Anthropic, "Effective harnesses for long-running agents", Nov 2025**: https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents. Its
...
3. **Model Context Protocol**: https://modelcontextprotocol.io/ (Anthropic, Nov 2024. Multi-vendor stewardship 2025). JSON-schema'd tool registries as the declared action space
...
7. **Anthropic, "Effective context engineering for AI agents", Sep 2025**: https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents.
...
| Deterministic fan-out/pipeline topologies | `engineering/workflow-builder` (Workflow-tool .js + validator) | Nothing: route there when orchestrating the coding agent's Workflow tool |
