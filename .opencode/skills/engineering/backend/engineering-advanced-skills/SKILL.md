...
description: Index of 37 advanced engineering agent skills for the coding agent, Codex, Gemini CLI, Cursor, OpenClaw. Use when browsing or choosing among the POWERFUL-tier engineering skills: agent design, RAG, MCP servers, CI/CD, database design, observability, security auditing, changelog/release automation, reliability (SLO/chaos/flags/operators), platform ops.
---
...
### Codex CLI
```bash
npx agent-skills-cli add alirezarezvani/the assistant-skills/engineering
```
