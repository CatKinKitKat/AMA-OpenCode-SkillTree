...
4. Update README/README.zh-CN when the public user surface changes.
5. Keep live handoff/progress state under `/tmp/ict-engine-...`. Only admit
   typed product surfaces, tests, reviewed support examples, or explicit
   structured evidence outside `support/docs`.
