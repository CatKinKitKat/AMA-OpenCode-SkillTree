...
Install the plugin. The SKILL.md loads into every the coding agent session as context. The LLM reads it and (usually) follows it.

```
/plugin install karpathy-coder@the agent-code-skills
```
