...
export default function Home() {
  return (
    <main>
      <div className="text-4xl font-bold">Welcome to the-project</div>
      <div className="mt-4">
...
export const metadata: Metadata = {
  title: 'the-project - Build Better Products',
  description: 'Build better products with the the-project platform.',
};
