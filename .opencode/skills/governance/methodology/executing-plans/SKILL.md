...
**Note:** Tell your human partner that Aegis works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as the coding agent or Codex). If subagents are available, use aegis:subagent-driven-development instead of this skill.
