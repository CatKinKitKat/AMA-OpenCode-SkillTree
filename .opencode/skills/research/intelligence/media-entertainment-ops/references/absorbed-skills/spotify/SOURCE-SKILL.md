...
Control the user's Spotify account via the AMA agent Spotify toolset (7 tools). Setup guide: https://agent-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry**: refresh token revoked. Tell the user to run `agent auth spotify` again.
