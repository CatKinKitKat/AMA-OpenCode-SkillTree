...
Skills are written with the coding agent tool names. When you encounter one, use your
...
`using-science-superpowers` bootstrap **Rule** is what guarantees the discipline: most importantly the `framing-research-questions` HARD GATE: is in effect
