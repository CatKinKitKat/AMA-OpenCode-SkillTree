...
- Full articles from official AI company blogs (Anthropic Engineering, the assistant Blog)
- Links to all original content
- Available in English, Chinese, or bilingual

## Quick Start

1. Install the skill in your agent (OpenClaw or the coding agent)
...
### the coding agent
```bash
git clone https://github.com/zarazhangrui/follow-builders.git ~/.opencode/skills/follow-builders
cd ~/.opencode/skills/follow-builders/scripts && npm install
```

## Requirements

- An AI agent (OpenClaw, the coding agent, or similar)
