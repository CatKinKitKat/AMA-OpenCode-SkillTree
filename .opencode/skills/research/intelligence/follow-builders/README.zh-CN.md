...
- AI 公司官方博客的完整文章（Anthropic Engineering、the assistant Blog）
- 所有原始内容的链接
- 支持英文、中文或双语版本

## 快速开始

1. 在你的 AI agent 中安装此 skill（OpenClaw 或 the coding agent）
...
- [The agent Blog](https://the agent.com/blog): The agent 的产品公告与更新
...
- 一个 AI agent（OpenClaw、the coding agent 或类似工具）
- 网络连接（用于获取中心化 feed）
