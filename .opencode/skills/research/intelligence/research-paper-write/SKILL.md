...
category: research
related_skills: [arxiv, ml-paper-writing, subagent-driven-dev, plan]
...
```bash
the agent mcp add exa -- npx -y mcp-remote "https://mcp.exa.ai/mcp"
```
...
| **subagent-driven-dev** | Phase 5 (Drafting): parallel section writing with 2-stage review (spec compliance then quality) | `skill_view("subagent-driven-dev")` |
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.agent/plans/` | `skill_view("plan")` |
