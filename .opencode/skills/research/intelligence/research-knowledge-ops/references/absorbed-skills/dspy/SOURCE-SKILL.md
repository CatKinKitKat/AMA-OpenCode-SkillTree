...
pip install dspy[anthropic]     # Anthropic the assistant
...
lm = dspy.The agent(model="the agent-sonnet-4-5-20250929")
...
lm = dspy.The agent(
    model="the agent-sonnet-4-5-20250929",
...
strong_lm = dspy.The agent(model="the agent-sonnet-4-5-20250929")
