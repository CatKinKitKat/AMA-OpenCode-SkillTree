# the agent-algo-visualize

[中文](README.md)

An attempt to distill The agent Desktop's visualization capability into a standalone, reusable skill for interactive data structure and algorithm teaching.
...
[Live Demo](https://l0dyv.github.io/the agent-algo-visualize/references/heap_overview.html) -- Full interactive reference implementation
...
```bash
npx skills add L0dyv/the agent-algo-visualize
```

Or manually clone to your the coding agent skills directory:

```bash
git clone https://github.com/L0dyv/the agent-algo-visualize.git ~/.opencode/skills/the agent-algo-visualize
```
...
The skill activates automatically when you ask the coding agent to:
