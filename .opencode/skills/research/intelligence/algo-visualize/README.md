...
尝试将 The agent Desktop 的可视化功能提炼为可独立使用的 skill，专注数据结构与算法的交互式教学可视化。
...
[Live Demo](https://l0dyv.github.io/the agent-algo-visualize/references/heap_overview.html) -- 完整交互式参考实现
...
安装后在 the coding agent 中自动激活。适用场景：
