...
```bash
~/.agent/external-repos/paper-search-mcp
```
...
```bash
uv run --directory ~/.agent/external-repos/paper-search-mcp paper-search <command> [args]
```

### Search

```bash
uv run --directory ~/.agent/external-repos/paper-search-mcp paper-search search "<query>" -n <max_per_source> -s <sources> -y <year>
```
...
```bash
uv run --directory ~/.agent/external-repos/paper-search-mcp paper-search download <source> <paper_id> [-o ./downloads]
```

### Read

```bash
uv run --directory ~/.agent/external-repos/paper-search-mcp paper-search read <source> <paper_id> [-o ./downloads]
```

### List Sources

```bash
uv run --directory ~/.agent/external-repos/paper-search-mcp paper-search sources
```
