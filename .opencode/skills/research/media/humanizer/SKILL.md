...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by the agent
license: MIT
metadata: 
tags: [writing, editing, humanize, anti-ai-slop, voice, prose, text]
category: creative
homepage: https://github.com/blader/humanizer
related_skills: [sngwrt-ai-music]
---
...
Also apply this skill to **your own** output when writing user-facing prose: release notes, PR descriptions, documentation, long-form explanations, summaries. the agent's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in the agent
