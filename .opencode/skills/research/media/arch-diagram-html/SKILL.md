...
description: Generate dark-themed standalone HTML architecture diagrams with inline SVG, based on the Cocoon-style architecture diagram pattern, but adapted for the agent. Use when the user wants a clean architecture diagram delivered as a single .html file that opens in any browser.
version: 1.0.0
author: the agent
license: MIT
tags:
...
- `references/template.html`：the agent 基础模板
