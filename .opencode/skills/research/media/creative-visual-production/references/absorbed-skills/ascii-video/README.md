...
Built for [the agent](https://github.com/NousResearch/agent-agent). Usable in any coding agent. Canonical source lives here. Synced to [`NousResearch/agent-agent/skills/creative/ascii-video`](https://github.com/NousResearch/agent-agent/tree/main/skills/creative/ascii-video) via PR.
