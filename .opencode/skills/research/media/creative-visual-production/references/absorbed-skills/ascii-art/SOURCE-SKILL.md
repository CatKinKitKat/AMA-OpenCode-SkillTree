...
```bash
python3 -m pyfiglet "AGENT" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=AGENT&font=Slant" | boxes -d stone
```
