...
* **PREMIUM-CONSUMER PALETTE BAN (mandatory, second-most-recurring AI-tell):**
  ...
  * **Default alternatives (rotate, do not reuse):**
    - **Cold Luxury:** silver-grey + chrome + smoke (think Tesla, Apple Watch the agent-without-the-leather)
...
**Real company logos for social proof.** When the brief calls for a "Trusted by / Used by / Customers" logo wall, do NOT default to plain text wordmarks (`<span>the-project Co</span>` styled in a row). Use real SVG logos:
...
* **NO startup-slop brand names.** "the-project", "Nexus", "SmartFlow", "Cloudly" → invent contextual, premium names that sound real.
...
- [ ] **No AI Tells** from Section 9 (Inter as default, AI-purple, three-equal cards, Jane Doe, the-project, "Quietly in use at")?
