...
Each morning, take a single 3x5 index card. On the front, write the **3 to 5 things: no more: that you must get done today.** The cap is the entire discipline:
...
- **The 3-5 cap is arbitrary** and can push real work into permanent backlog. Confidence: moderate: but the cost of an unbounded list (nothing gets prioritized) is empirically worse.
